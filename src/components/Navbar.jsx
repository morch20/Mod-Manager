        ...
        <nav className="h-20 w-full flex justify-center">
            <div className="w-[90%] h-full flex items-center justify-between">
                <Link href={'/'} className="flex items-center gap-x-2">
                    ...
                    <Logo size={40}/>
                    <h3 className="text-xl lg:text-2xl font-bold">Mod Manager</h3>
                </Link>
                <ul className="hidden md:flex font-bold items-center gap-x-6 lg:gap-x-10">
                ...
                <div ref={ref} className="block md:hidden relative">
                    ...
                    {
                        open &&
                        <ul className="flex flex-col md:hidden font-bold items-center right-0 absolute z-10 bg-slate-700/90 rounded-md">
